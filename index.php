    ...
    <div class="container-fluid py-4">
          ...
          <div class="col-12">
            <div class="card mb-4" style="background-color: white">
              <div class="card-header pb-0 d-flex justify-content-between align-items-center" style="background-color: white">
                <h6>Users</h6>
                <div>
                  <a href="" class="btn btn-primary" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">New User</a>
                </div>
              </div>
                  ...
                  <table class="table align-items-center mb-0" style="height: auto">
                    <thead>
                      <tr>
                        ...
                        <th class="text-start text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">username</th>
                      ...
                      ?>
                          <tr>
                            <td class="align-middle text-start">
                              <img src="<?php echo $user['profile']; ?>" style="max-width:40px;" class="rounded-circle ms-3">
                            </td>
                            <td class="align-middle text-start"><?php echo $user['username']; ?></td>
                            <td class="align-middle text-center"><?php echo $user['email']; ?></td>
                            <td class="align-middle text-center">
                              <span class="text-secondary text-xs font-weight-bold"><?php echo $user['role']; ?></span>
                            </td>
                            <td class="align-middle text-center">
                              <a href="../edit-view.php?id=<?= base64_encode($user['id'])?>" class="badge badge-sm bg-gradient-primary text-center" style="border: none">
                                <i class="bx bxs-edit"></i>
                              </a>
                              <a href="../delete.php?id=<?= $user['id'] ?>" class="badge badge-sm bg-gradient-danger text-center" style="border: none">
      ...
      <div
        ...
        <div class="offcanvas-header">
          <h5 id="offcanvasRightLabel">New User</h5>
        ...
        <div class="offcanvas-body">
          <form action="add-users.php" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
              <div class="cards">
                <img src="../public/images/avatar.jfif" id="image" style="width: 120px; height: 120px; object-fit: cover" />
            ...
            <button type="submit" class="btn btn-primary" style="float: right" name="submit">Create</button>
          </form>
        </div>
      </div>
